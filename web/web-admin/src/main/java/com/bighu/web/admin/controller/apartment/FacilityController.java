...
import com.bighu.web.admin.service.FacilityInfoService;
...
public class FacilityController {
    ...
    public Result<List<FacilityInfo>> listFacility(@RequestParam(required = false) ItemType type) {
        LambdaQueryWrapper<FacilityInfo> facilityInfoLambdaQueryWrapper = new LambdaQueryWrapper<FacilityInfo>();
